...
export const TEAM_MEMBERS = [
  ...
  {
    name: 'Arnab Poddar (Sir)',
    role: 'PGT Biology — Project Guide & Mentor',
    badge: 'Faculty Guide',
    program: 'Science & Innovation Mentorship',
    bio: 'Guiding scientific research methodology, biological and environmental water conservation principles, and INSPIRE-MANAK project documentation.',
    avatarInitials: 'AP',
    focus: 'Scientific review, safety verification, and environmental impact assessment.',
  },
  {
    name: 'Mrinmoy Chowhan (Sir)',
    role: 'ATL Lab Mentor',
    badge: 'Partner Lab / ATL Mentor',
    program: 'Atal Tinkering Lab (ATL) Mentorship',
    bio: 'Mentoring embedded hardware prototyping, sensor fabrication, ATL test rig development, and practical engineering execution.',
    avatarInitials: 'MC',
    portfolio: 'https://mrinmoychowhan.lovable.app/',
    focus: 'ATL laboratory facilities, embedded prototyping, and sensor test rig fabrication.',
  },
];
